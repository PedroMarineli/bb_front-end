        ...
        <section className="grid justify-items-center">
            ...
            <div className="flex items-center gap-10">
                ...
                <div>
                    ...
                    <p>A Burger Boss nasceu da paixão por hambúrgueres suculentos e ingredientes frescos. Tudo começou quando nosso fundador, Bob Grillman, decidiu transformar sua receita secreta de hambúrguer em um negócio. Com muito amor pela gastronomia e uma pitada de ousadia, a Burger Boss ganhou vida.</p>
