...
import SetaDireita from "/icons/seta-direita.png";
...
const Relatorios = () => {
    ...
    return(
        <div>
            <div onClick={proximoRelatorio} className="flex flex-col fixed bottom-1/2 right-20 p-5 bg-white rounded-full border-solid border-2 border-black hover:cursor-pointer">
            ...
            <div onClick={relatorioAnterior} className="flex flex-col fixed bottom-1/2 left-20 p-5 bg-white rounded-full border-solid border-2 border-black hover:cursor-pointer">
